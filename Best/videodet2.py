...
class ObjectDetectionApp(QMainWindow):
    def __init__(self):
        ...
        self.video_writer = None  # Video writer for saving processed video
    ...
    def process_frame(self, frame):
        ...
        for result in results:
            boxes = result.boxes
            masks = result.masks  # Get masks if available
            ...
            if masks is not None:
                for mask in masks:
                    ...
                    cv2.fillPoly(frame, [mask], (0, 255, 0, 50))  # Draw mask with transparency
