        ...
        try:
            ...
            async for message in self.client.iter_messages(channel):
                ...
                if message.media and isinstance(message.media, MessageMediaPhoto):
                    ...
                    filename_sanitized = sanitize_filename(filename_base) + ext
...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        date_layout.addWidget(self.export_excel_checkbox)
        date_layout.addWidget(self.preserve_names_checkbox)
